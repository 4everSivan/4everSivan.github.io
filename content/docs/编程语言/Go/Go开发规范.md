---
title: "Go开发规范"
lastmod: "2024-09-09T10:56:33+08:00"
---
...
#### 7.1 【必须】go1.11以上必须使用go modules模式：
...
![img](https://img2022.cnblogs.com/blog/1238257/202205/1238257-20220510101439545-1714807371.webp)
...
建议所有不对外开源的工程的module name使用`gitlab.gzky.com/group/repo`，方便他人直接引用

建议使用go modules管理依赖的项目，不要将`go.sum`、`go.mod`文件添加到`.gitignore`规则中

使用规范的提交信息，提高代码库的可读性和可维护性，为团队协作和项目管理带来显著的优势
